...
| Preparacion para MySQL | Al exportar el dataset limpio a CSV fue necesario verificar que los decimales quedaran con punto (`.`) y no con coma (`,`), porque MySQL puede fallar al importar numeros con coma decimal. |
